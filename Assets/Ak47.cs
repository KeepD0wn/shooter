...
public class Ak47 : AllWeapon
{
    public GameObject akPref;
   ...
   public override void ForceHit(RaycastHit hit) 
    ...
    {
        GameObject ak = Instantiate(akPref,transform.position, Quaternion.identity);
        ak.GetComponent<Rigidbody>().velocity = transform.forward * 3f;
        IsDropped = true;
    ...
    private void OnGUI()
    {
        GUI.Label(new Rect(20,20,200,25),"AK patrons / "+CurrenPatrons);
    }
}
